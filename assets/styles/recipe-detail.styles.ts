...
export const recipeDetailStyles = StyleSheet.create({
  ...
  floatingSaveButton: { justifyContent: "center", alignItems: "center" },
  titleSection: {
    position: "absolute",
    bottom: 45,
    left: 16,
  ...
  recipeTitleContainer: { alignSelf: "flex-start" },
  recipeTitle: {
  ...
  recipeTitlePressed: { opacity: 0.9 },
  categoryBadge: {
    alignSelf: "flex-start",
